...
//#define PIN_PWM3	GPIOB10			// se o timer dor alterado esse valores consequentemente
//#define PIN_PWM4	GPIOB11			// tabem serão alterados


// CAN BE CHANGED
#define TIM_PWM1	TIM4			// ao alterar o timer cuide de utilizara a função
#define PERIPH_PWM1	RCC_APB1Periph_TIM4	// do baramento respequitivo e os PIN_PWMx

#define PIN_PWM1	GPIOB6			// pino que corresondos a saidas do canal do
#define PIN_PWM2	GPIOB7			// timer utilisado
#define PIN_PWM3	GPIOB8			// se o timer dor alterado esse valores consequentemente
#define PIN_PWM4	GPIOB9			// tabem serão alterados
